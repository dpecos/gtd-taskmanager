 ...
 */
public class CopyOfGoogleAccountActivity extends Activity {
		...
		case DIALOG_ACCOUNTS:
			...
			builder.setOnCancelListener(new OnCancelListener() {
				...
				public void onCancel(DialogInterface dialog) {
					CopyOfGoogleAccountActivity.this.setResult(RESULT_CANCELED);
					CopyOfGoogleAccountActivity.this.finish();
				}
			});
