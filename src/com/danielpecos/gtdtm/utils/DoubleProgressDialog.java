...
public class DoubleProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = (ProgressBar) view.findViewById(R.id.ddp_progress);
        mSecondaryProgress = (ProgressBar) view.findViewById(R.id.ddp_secondaryProgress);

        mProgressNumber = (TextView) view.findViewById(R.id.ddp_progress_number);
        mProgressNumberFormat = "%d/%d";
        mProgressPercent = (TextView) view.findViewById(R.id.ddp_progress_percent);
        mProgressPercentFormat = NumberFormat.getPercentInstance();
        mProgressPercentFormat.setMaximumFractionDigits(0);

        mSecondaryProgressNumber = (TextView) view.findViewById(R.id.ddp_secondary_progress_number);
        mSecondaryProgressPercent = (TextView) view.findViewById(R.id.ddp_secondary_progress_percent);
